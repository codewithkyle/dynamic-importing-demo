...
var App = /** @class */ (function () {
    function App() {
        ...
        this.handleLoad = function (e) {
            fetch(window.location.origin + "/ajax.html").then(function (response) {
                response.text().then(function (responseText) {
                    var tempDocument = document.implementation.createHTMLDocument('temp-doc');
                    tempDocument.documentElement.innerHTML = responseText;
                    var newContainer = tempDocument.documentElement.querySelector('.js-container');
                    _this._container.innerHTML = newContainer.innerHTML;
                    var script = tempDocument.documentElement.querySelector('script');
